...
object Color {
  ...
  val DEFAULT = Color("DEFAULT")
  val DARK_GRAY = Color("DARK_GRAY")
  val LIGHT_RED = Color("LIGHT_RED")
  val LIGHT_GREEN = Color("LIGHT_GREEN")
  val LIGHT_YELLOW = Color("LIGHT_YELLOW")
  val LIGHT_BLUE = Color("LIGHT_BLUE")
  val LIGHT_MAGENTA = Color("LIGHT_MAGENTA")
  val LIGHT_CYAN = Color("LIGHT_CYAN")
